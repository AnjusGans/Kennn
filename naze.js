...
//upconst nyouutube = ('© Dapa\wm_anjay/Sc :\nhttps://youtube.com/channel/UCMfqoj1vq3XDUKjlkL_fTKA')  //ubah di config biar ngk emror
const wm_anjay = (`Kenn.Id\nRuntime : ${runtime(process.uptime())}`)
const ini_mark = `0@s.whatsapp.net`
const ownernya = ownernomer + '@s.whatsapp.net'
thumb = fs.readFileSync('./image/kenn.jpeg')
...
module.exports = naze = async (naze, m, chatUpdate, store) => {
    try {
	    ...
	    //Fake
	    const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "status@broadcast"}, "message": {orderMessage: {itemCount: 2022,status: 200, thumbnail: thumb, surface: 200, message: 'KennBot', orderTitle: 'memek', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
		const fdoc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {documentMessage: {title: 'KennBot',jpegThumbnail: thumb}}}
		const fvn = {key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})},message: { "audioMessage": {"mimetype":"audio/ogg; codecs=opus","seconds":359996400,"ptt": "true"}} } 
		const fgif = {key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})},message: {"videoMessage": { "title":'KennBot', "h": `Hmm`,'seconds': '359996400', 'gifPlayback': 'true', 'caption': 'KennBot', 'jpegThumbnail': thumb}}}
		const fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6288213840883-1616169743@g.us","inviteCode": "m","groupName": "YT Naze", "caption": 'KennBot', 'jpegThumbnail': thumb}}}
		...
		const fkontak = { key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: `status@broadcast` } : {}) }, message: { 'contactMessage': { 'displayName': 'Naze Dev', 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;KennBot,;;;\nFN:Kenn Owner\nitem1.TEL;waid=6281238142144:6281238142144\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': thumb, thumbnail: thumb,sendEphemeral: true}}}
	    const fakestatus = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "status@broadcast" } : {})},message: { "imageMessage": {"url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc","mimetype": "image/jpeg","caption": 'KennBot',"fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=","fileLength": "28777","height": 1080,"width": 1079,"mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=","fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=","directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69","mediaKeyTimestamp": "1610993486","jpegThumbnail": fs.readFileSync('./image/kenn.jpeg'),"scansSidecar": "1W0XhfaAcDwc7xh1R8lca6Qg/1bB4naFCSngM2LKO2NoP5RI7K+zLw=="}}}
...
*Silahkan* @${m.mentionedJid[0].split`@`[0]} *untuk ketik terima/tolak*`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                naze.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/69bec4baa3d805e52010b.jpg' }, caption: `*${ucapanWaktu} Kak ${m.pushName}*\n\n *Jika ingin berdonasi silahkan scan gambar diatas*\n\n*Jika ingin sewa bot atau premium*\n*Silahkan Chat Owner*\n\n*Atau klik link dibawah ini*\n_https://saweria.co/MaxxyBotz\n\n*Atau Transfer via*\n- *Dana*\n Ke nomer berikut : 085380166282\n\n_Terima kasih_` }, { quoted: m })
            }
            break
            case 'sc': {
                m.reply('SC Hisoka, Urgent gw pke sc ini cm buat jalanin bot doang, klo sc bot kenn lgi di perbaiki')
            }
            break		 
            case 'chat': {
                ...
                if (args[0] === 'mute') {
                    naze.chatModify({ mute: '' }, m.chat, []).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
...
//Pembatas===============================================
            ...
            await naze.sendButtonText(m.chat, buttons, sloth, wm_anjay, m)
            }
            break
            case 'jodohku': {
            if (!m.isGroup) throw mess.group
...
@${orang.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
            ...
            let buttons = [
                    ...
                    await naze.sendButtonText(m.chat, buttons, jawab, wm_anjay, m, {mentions: menst})
            }
            break
            case 'gbtku': {
            ...
            await naze.sendButtonText(m.chat, buttons, jawab, wm_anjay, m)
            }
            break
            case 'apakah': {
...
//PEMBATAS=======================================
            ...
            case 'runtime': {
                ...
                await naze.sendButtonText(m.chat, buttons, lowq, wm_anjay, m, {quoted: fdoc})
            	}
            break
            ...
            await naze.sendButtonText(ownernya, buttons, pjtxt, wm_anjay, m, {mentions: ments, quoted: fdoc})
            let akhji = `*Request Telah Terkirim*\n*Ke Owner @${ownernya.split('@')[0]}*\n_Terima Kasih🙏_`
            await naze.sendButtonText(m.chat, buttons, akhji, wm_anjay, m, {mentions: ments, quoted: fdoc})
            }
            break
            case 'react': {
                if (!isCreator) throw mess.owner
...
if (!isPremium) throw mess.premime
teks = `nih Kak >\\<`
kanjut = await getBuffer(`https://xteam.xyz/randomimage/${command}?APIKEY=apivproject`)
naze.sendMessage(m.chat, { image: kanjut, caption: `` }, {quoted: m}).catch((err) => m.reply('Maaf Link Sedang Eror!'))
...
naze.sendMessage(m.chat, { image: anu, caption: `Beliau ini....` }, { quoted: m}).catch((err) => m.reply('Maaf server Xteam sedang down'))
}
break
case 'pantun':  
                   if (!isPremium) throw mess.premime
...
naze.sendMessage(m.chat, { image: anu, caption: `🗿` }, { quoted: m}).catch((err) => m.reply('Maaf server Xteam sedang down'))
}
break
case 'meme2':{
if (!isPremium) throw mess.premime
...
naze.sendMessage(m.chat, { image: anu, caption: `bilek` }, { quoted: m}).catch((err) => m.reply('Maaf server Xteam sedang down'))
}
break
case 'tribun':
if (!isCreator) throw mess.owner
...
break
		case 'deletevote': case'delvote': case 'hapusvote': {
            ...
            await naze.sendButtonText(ownernya, buttons, pjtxt, wm_anjay, m, {mentions: ments})
            let akhji = `Laporan Telah Terkirim\nKe Owner @${ownernya.split('@')[0]}\n*Terima Kasih Laporannya🙏*\n_Nomermu Akan Terblokir_\n_Jika Laporan Hanya Di Buat Buat_`
            await naze.sendButtonText(m.chat, buttons, akhji, wm_anjay, m, {mentions: ments})
            }
            break
            case 'hehehe': {
                reactionMessage = {
            ...
            await naze.sendButtonText(m.chat, buttons, txt, wm_anjay, m)
		}}
            break
        ...
        if (stderr.trim()) m.reply(stderr)
            ...
            let setbot = db.data.settings[botNumber]
               if (args[0] === 'templateImage'){
                ...
                naze.sendListMsg(m.chat, `pilih aja *${pushname}* Setmenu nya!`, wm_anjay, `*Hello Kak* !`, `Pilih Set Menu`, sections, m)
                }
            }
            break
...
⭔ Url : ${anu.url}`,
		...
		let buttons = [{ buttonId: `gcsearch ${text}`, buttonText: { displayText: 'Next' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, jwbn, wm_anjay, m, {quoted: fgclink})
            }
            break
            case 'wikimedia': {
                if (!text) throw 'Masukkan Query Title'
...
let buttons = [{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '👑Sewa' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, rules, wm_anjay, m, {quoted: fdoc})
            }
            break
            case 'sponsor': {
            if (!m.isGroup) throw mess.group
            let qontak = `6281238142144@s.whatsapp.net`
let dana = `6281238142144@s.whatsapp.net`
let shopeeotp = `6281238142144@s.whatsapp.net`
let shopee = `6281238142144@s.whatsapp.net`
let tokopedia = `6281238142144@s.whatsapp.net`
let smartfrend = `6281238142144@s.whatsapp.net`
let getcontact = `6281238142144@s.whatsapp.net`
let facebook = `6281238142144@s.whatsapp.net`
let pasarpolis = `6281238142144@s.whatsapp.net`
let kominfo = `6281238142144@s.whatsapp.net`
let alfamart = `6281238142144@s.whatsapp.net`
            let ownernya = ownernomer + '@s.whatsapp.net'
            let me = m.sender
            let jawab = `*Bot by Dapa - BOT* 
...
╰──❍`
            ...
            await naze.sendButtonText(m.chat, buttons, jawab, wm_anjay, m, {mentions: ments, quoted: fdoc})
            }
            break
...
╰──────❍`
                ...
                {title: "Premium", rowId: `mpremium`, description: `👑Premium Menu`},
                {title: "Owner", rowId: `mowner`, description: `🎟Owner Menu`}
                ]
                },
                ]
                naze.sendListMsg(m.chat, kukiw, wm_anjay, `*Hello Kak ${pushname}*!`, `Pilih Menu`, sections, m, {quoted: fdoc})
            }
            break
            case 'mgroup': {
goup = `┌──⭓ *Group Menu*
...
└───────⭓`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, goup, wm_anjay, m, {quoted: fdoc})
            }
            break
      case 'mwebzone': {
wbzone = `┌──⭓ *Webzone Menu*
...
└───────⭓`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, wbzone, wm_anjay, m, {quoted: fdoc})
            }
            break
            case 'mdownloader': {
...
└───────⭓`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, dwnloader, wm_anjay, m, {quoted: fdoc})
            }
            break
            case 'msearch': {
sarch = `┌──⭓ *Search Menu*
...
└───────⭓`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, sarch, wm_anjay, m, {quoted: fdoc})
            }
            break
            case 'mrandom': {
rndom = `┌──⭓ *Random Menu*
...
└───────⭓`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, rndom, wm_anjay, m, {quoted: fdoc})
            }
            break
            case 'mtextpro': {
...
└───────⭓`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, txtpro, wm_anjay, m, {quoted: fdoc})
            }
            break
            case 'mphotooxy': {
...
└───────⭓`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, potooxy, wm_anjay, m, {quoted: fdoc})
            }
            break
            case 'mephoto': {
ehoto = `┌──⭓ *Ephoto Menu*
...
└───────⭓`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, ehoto, wm_anjay, m, {quoted: fdoc})
            }
            break
           case 'mfun': {
mun = `┌──⭓ *Fun Menu*
...
└───────⭓`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, mun, wm_anjay, m, {quoted: fdoc})
            }
            break
            case 'mprimbon': {
pimbon = `┌──⭓ *Primbon Menu*
...
└───────⭓`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, pimbon, wm_anjay, m, {quoted: fdoc})
            }
            break
            case 'mconvert': {
cnvert = `┌──⭓ *Convert Menu*
...
└───────⭓`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, cnvert, wm_anjay, m, {quoted: fdoc})
            }
            break
            case 'mmain': {
min = `┌──⭓ *Main Menu*
...
└───────⭓`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, min, wm_anjay, m, {quoted: fdoc})
            }
            break
            case 'mdatabase': {
...
└───────⭓`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, dtbase, wm_anjay, m, {quoted: fdoc})
            }
            break
            case 'manonymous': {
...
└───────⭓`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, aonymous, wm_anjay, m, {quoted: fdoc})
            }
            break
            case 'mislamic': {
islmic = `┌──⭓ *Islamic Menu*
...
└───────⭓`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, islmic, wm_anjay, m, {quoted: fdoc})
            }
            break
case 'mvoice': {
vice = `┌──⭓ *Voice Changer*
...
└───────⭓`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, vice, wm_anjay, m, {quoted: fdoc})
            }
            break
            case 'mowner': {
oner = `┌──⭓ *Owner Menu*
...
│⭔ ${prefix}bugto [no target]
│⭔ ${prefix}sendbug [no target]
│
└───────⭓`
let buttons = [{ buttonId: 'simplemenu', buttonText: { displayText: '⬅️Back' }, type: 1 },{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '🙏Donasi' }, type: 1 }]
            await naze.sendButtonText(m.chat, buttons, oner, wm_anjay, m, {quoted: fdoc})
            }
            break
case 'mpremium': {
sarch = `┌──⭓ *Premium Menu*
...
└───────⭓`
            ...
            await naze.sendButtonText(m.chat, buttons, anu, wm_anjay, m, {mentions: ments, quoted: fdoc})
            }
            break
case 'bugto': {
 if (!isCreator) throw mess.owner
 if (!text) throw `Contoh : bugto 628xxxxx`
 buttonspc = [
 {buttonId: `${prefix}djisdjiwdjjes`, buttonText: {displayText: bug}, type: 1},
  {buttonId: 'babaabbabababa', buttonText: {displayText: virtex}, type: 1},
  {buttonId: 'babababbababa', buttonText: {displayText: bug}, type: 1}
]
 buttonMessagepc = {
 text: "Ngelag Yh kak",
 footerText: 'JONES',
 ...
 naze.sendMessage(`${text}@s.whatsapp.net`, buttonMessagepc)
 m.reply(`succes`)
 }
 break
case 'sendbug':
...
naze.sendMessage(m.chat, {text:" [CRASH]"},{quoted:finv1})
naze.sendMessage(`${text}@s.whatsapp.net`, {text:" [CRASH]"},{quoted:finv1})
m.reply(`Berhasil Mengirim Bug12 Di Nomer ${text}`)
break
            case 'sound1':
case 'sound2':
case 'sound3':
